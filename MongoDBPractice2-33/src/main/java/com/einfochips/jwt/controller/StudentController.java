...
public class StudentController {
	...
	@GetMapping("/getStudentByDepartMentID")
	public Optional<List<Students>> getStudentByDepartMentID(@RequestParam String id) {
		return studentService.getStudentByDepartmentID(id);
	}
	
	@GetMapping("/getStudentByName")
	public Optional<List<Students>> getStudentByName(@RequestParam String name) {
		return studentService.getStudentByName(name);
	}
	
	@GetMapping("/getStudentByNameAndEmail")
	public Optional<List<Students>> getStudentByNameAndEmail(@RequestParam String name,@RequestParam String email) {
